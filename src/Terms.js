  ...
  render() {
    return (
		...
		<Jumbotron className="Question-header text-center" color="white">
			<h1>Pulse Q&A Terms of Service</h1>
	    </Jumbotron>
      	<ListGroup>
	        <ListGroupItem>
				...
				<ListGroupItemText>ARBITRATION NOTICE: THESE TERMS CONTAIN AN ARBITRATION CLAUSE A LITTLE LATER ON. EXCEPT FOR CERTAIN TYPES OF DISPUTES MENTIONED IN THAT ARBITRATION CLAUSE, YOU AND PULSE LLC AGREE THAT DISPUTES BETWEEN US WILL BE RESOLVED BY MANDATORY BINDING ARBITRATION, AND YOU AND PULSE LLC WAIVE ANY RIGHT TO PARTICIPATE IN A CLASS-ACTION LAWSUIT OR CLASS-WIDE ARBITRATION.</ListGroupItemText>
	        </ListGroupItem>
	        <ListGroupItem>
	          <ListGroupItemHeading><strong>1. Who Can Use the Services</strong></ListGroupItemHeading>
				...
				<ListGroupItem>You can form a binding contract with Pulse LLC</ListGroupItem>
	        ...
	        <ListGroupItem>
	          ...
	          <ListGroupItemText>Our Services via the Pulse Q&A application or website let you create, upload, post, send, receive, and store content. When you do that, you retain whatever ownership rights in that content you had to begin with. But you grant us a license to use that content. For all our Services, you grant Pulse LLC and our affiliates a worldwide, royalty-free, sublicensable, and transferable license to host, store, use, display, reproduce, modify, adapt, edit, publish, and distribute that content. This license is for the limited purpose of operating, developing, providing, promoting, and improving the Services and researching and developing new ones.</ListGroupItemText>
			  <ListGroupItemText>Given the inherently public nature of the Services, the license you grant us for content submitted also grants us the perpetual license to create derivative works from, promote, exhibit, broadcast, syndicate, sublicense, publicly perform, and publicly display content submitted to our Services in any form and in any and all media or distribution methods (now known or later developed). To the extent it’s necessary, when you submit your content, you also grant Pulse LLC, our affiliates, and our business partners the unrestricted, worldwide, perpetual right and license to use your name, likeness, and voice. This means, among other things, that you will not be entitled to any compensation from Pulse LLC, our affiliates, or our business partners if your name, likeness, or voice is conveyed through our Services, either on the Pulse Q&A application or on one of our business partner’s platforms.</ListGroupItemText>
	        ...
	        <ListGroupItem>
	          ...
	          <ListGroupItemText>
				Your privacy matters to us. You can learn how we handle your information when you use our Services by reading our Privacy Policy. We encourage you to give the Privacy Policy a careful look because, by using our Services, you agree that Pulse LLC can collect, use, and share your information consistent with that policy.
	          </ListGroupItemText>
	        </ListGroupItem>
	        <ListGroupItem>
	          <ListGroupItemHeading><strong>6. Respecting Other People's Right</strong></ListGroupItemHeading>
	          <ListGroupItemText>Pulse LLC respects the rights of others. And so should you. You therefore may not use the Services in a manner that:</ListGroupItemText>
				<ListGroup className="showBullets">
				...
				<ListGroupItemText>You must also respect Pulse LLC’s rights. These Terms do not grant you any right to:</ListGroupItemText>
				<ListGroup className="showBullets">
	        ...
	        <ListGroupItem>
	          ...
	          <ListGroupItemText>Pulse LLC honors the requirements set forth in the Digital Millennium Copyright Act. We therefore take reasonable steps to expeditiously remove from our Services any infringing material that we become aware of. And if Pulse LLC becomes aware that one of its users has repeatedly infringed copyrights, we will take reasonable steps within our power to terminate the user’s account.</ListGroupItemText>
	        ...
	        <ListGroupItem>
	          ...
	          <ListGroupItemText>
				If you use a service, feature, or functionality that is operated by a third party and made available through our Services (including Services we jointly offer with the third party), each party’s terms will govern the respective party’s relationship with you. Pulse LLC is not responsible or liable for a third party’s terms or actions taken under the third party’s terms.
	          </ListGroupItemText>
	        </ListGroupItem>	
	        <ListGroupItem>
	          ...
	          <ListGroupItemText>We’re relentlessly improving our Services and creating new ones all the time. That means we may add or remove features, products, or functionalities, and we may also suspend or stop the Services altogether. We may take any of these actions at any time, and when we do, we may not provide you with any notice beforehand.</ListGroupItemText>
				...
				<ListGroupItemText>Pulse LLC may also terminate these Terms with you at any time, for any reason, and without advanced notice. That means that we may stop providing you with any Services, or impose new or additional limits on your ability to use our Services. For example, we may deactivate your account due to prolonged inactivity, and we may reclaim your username at any time for any reason.</ListGroupItemText>
				<ListGroupItemText>Regardless of who terminates these Terms, both you and Pulse LLC continue to be bound by Sections 3, 6, 9, 10, and 13-22 of the Terms.</ListGroupItemText>
	        </ListGroupItem>		
	        <ListGroupItem>
	          <ListGroupItemHeading><strong>13. Indemnity</strong></ListGroupItemHeading>
	          <ListGroupItemText>
				You agree, to the extent permitted by law, to indemnify, defend, and hold harmless Pulse LLC, our affiliates, directors, officers, stockholders, employees, licensors, and agents from and against any and all complaints, charges, claims, damages, losses, costs, liabilities, and expenses (including attorneys’ fees) due to, arising out of, or relating in any way to: (a) your access to or use of the Services; (b) your content; and (c) your breach of these Terms.
	          </ListGroupItemText>
	        </ListGroupItem>      
	        <ListGroupItem>
			  ...
			  <ListGroupItemText>THE SERVICES ARE PROVIDED “AS IS” AND “AS AVAILABLE” AND TO THE EXTENT PERMITTED BY LAW WITHOUT WARRANTIES OF ANY KIND, EITHER EXPRESS OR IMPLIED, INCLUDING, BUT NOT LIMITED TO, IMPLIED WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, TITLE, AND NON-INFRINGEMENT. IN ADDITION, WHILE PULSE LLC ATTEMPTS TO PROVIDE A GOOD USER EXPERIENCE, WE DO NOT REPRESENT OR WARRANT THAT: (A) THE SERVICES WILL ALWAYS BE SECURE, ERROR-FREE, OR TIMELY; (B) THE SERVICES WILL ALWAYS FUNCTION WITHOUT DELAYS, DISRUPTIONS, OR IMPERFECTIONS; OR (C) THAT ANY CONTENT, USER CONTENT, OR INFORMATION YOU OBTAIN ON OR THROUGH THE SERVICES WILL BE TIMELY OR ACCURATE.</ListGroupItemText>
			  <ListGroupItemText>PULSE LLC TAKES NO RESPONSIBILITY AND ASSUMES NO LIABILITY FOR ANY CONTENT THAT YOU, ANOTHER USER, OR A THIRD PARTY CREATES, UPLOADS, POSTS, SENDS, RECEIVES, OR STORES ON OR THROUGH OUR SERVICES. YOU UNDERSTAND AND AGREE THAT YOU MAY BE EXPOSED TO CONTENT THAT MIGHT BE OFFENSIVE, ILLEGAL, MISLEADING, OR OTHERWISE INAPPROPRIATE, NONE OF WHICH PULSE LLC WILL BE RESPONSIBLE FOR.</ListGroupItemText>
	        </ListGroupItem>  	
	        <ListGroupItem>
	          <ListGroupItemHeading><strong>15. Limitation of Liability</strong></ListGroupItemHeading>
	          <ListGroupItemText>
			TO THE MAXIMUM EXTENT PERMITTED BY LAW, PULSE LLC AND OUR MANAGING MEMBERS, SHAREHOLDERS, EMPLOYEES, AFFILIATES, LICENSORS, AND SUPPLIERS WILL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, PUNITIVE, OR MULTIPLE DAMAGES, OR ANY LOSS OF PROFITS OR REVENUES, WHETHER INCURRED DIRECTLY OR INDIRECTLY, OR ANY LOSS OF DATA, USE, GOODWILL, OR OTHER INTANGIBLE LOSSES, RESULTING FROM: (A) YOUR ACCESS TO OR USE OF OR INABILITY TO ACCESS OR USE THE SERVICES; (B) THE CONDUCT OR CONTENT OF OTHER USERS OR THIRD PARTIES ON OR THROUGH THE SERVICES; OR (C) UNAUTHORIZED ACCESS, USE, OR ALTERATION OF YOUR CONTENT, EVEN IF PULSE LLC HAS BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES. IN NO EVENT WILL PULSE LLC’S AGGREGATE LIABILITY FOR ALL CLAIMS RELATING TO THE SERVICES EXCEED THE GREATER OF $100 USD OR THE AMOUNT YOU PAID PULSE LLC, IF ANY, IN THE LAST 12 MONTHS.
	          </ListGroupItemText>
	        </ListGroupItem>  	
	        <ListGroupItem>
	          ...
	          <ListGroupItemText>
				To the extent that these Terms allow you or Pulse LLC to initiate litigation in a court, both you and Pulse LLC agree that all claims and disputes (whether contract, tort, or otherwise), including statutory claims and disputes, arising out of or relating to the Terms or the use of the Services will be litigated exclusively in the United States District Court for the Central District of California. If, however, that court would lack original jurisdiction over the litigation, then all such claims and disputes will be litigated exclusively in the Superior Court of California, County of Los Angeles. You and Pulse LLC consent to the personal jurisdiction of both courts.
	          </ListGroupItemText>
	        </ListGroupItem>
	        <ListGroupItem>
	        ...
	        <ListGroupItem>
	          <ListGroupItemHeading><strong>21. Final Terms</strong></ListGroupItemHeading>
	          	<ListGroup className="showBullets">
	          		<ListGroupItem>These Terms (together with any additional terms applicable to specific Services you use) make up the entire agreement between you and Pulse LLC, and supersede any prior agreements.</ListGroupItem>
	        ...
	        <ListGroupItem>
	          ...
	          <ListGroupItemText>
				Pulse LLC welcomes comments, questions, concerns, or suggestions. Please send us feedback by emailing hi@checkpulse.co.
	          </ListGroupItemText>
	        </ListGroupItem>	        	        	                	                     	        	                	        	               	        
      </ListGroup>
      </Container>
